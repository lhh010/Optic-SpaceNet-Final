...
================================================================================
 ...
 模型:
   Model 1 (Baseline VGG Mixed):    baseline_vgg_mixed_ste.pth  训练 98.26%
   Model 2 (SpaceNet V1 Mixed):     spacenet_v1_mixed_ste.pth   训练 91.26%
   Model 3 (SpaceNet V2 KD Mixed):  spacenet_v2_mixed_ste.pth   训练 91.13%
...
def print_report(results_qat, results_optic):
    ...
    print(f"    Model 1 Mixed: 98.26% int4  (baseline_vgg_mixed_ste.pth)")
    print(f"    Model 2 Mixed: 91.26% int4  (spacenet_v1_mixed_ste.pth)")
    print(f"    Model 3 Mixed: 91.13% int4  (spacenet_v2_mixed_ste.pth)")
    print("=" * 100)
...
def main():
    ...
    models = [
        {"class": BaselineVGG_Mixed, "weight": "baseline_vgg_mixed_ste.pth",
         "name": "Model 1 Mixed (VGG+BN)", "arch": "flat+BN"},
        {"class": OpticSpaceNet_Mixed, "weight": "spacenet_v1_mixed_ste.pth",
         "name": "Model 2 Mixed (SpaceNet V1)", "arch": "seq+BN"},
        {"class": OpticSpaceNet_Mixed, "weight": "spacenet_v2_mixed_ste.pth",
