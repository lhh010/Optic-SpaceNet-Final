...
================================================================================
 ...
 模型:
   Model 1 (Baseline):    Mini-VGG, 3x3 convs  → baseline_vgg.pth
   Model 2 (SpaceNet V1): HW-aligned CNN       → spacenet_v1.pth
   Model 3 (SpaceNet V2): Distilled CNN        → spacenet_v2_distilled.pth
