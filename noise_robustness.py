...
def generate_noise_plot(all_results: dict, save_path: str = "noise_robustness.png"):
    """
...
def main():
    ...
    # 定义模型
    models_config = [
        {"class": BaselineVGG,   "weight": "baseline_vgg.pth",          "name": "Model 1 (Baseline VGG)"},
        {"class": OpticSpaceNet, "weight": "spacenet_v1.pth",           "name": "Model 2 (SpaceNet V1)"},
        {"class": OpticSpaceNet, "weight": "spacenet_v2_distilled.pth", "name": "Model 3 (SpaceNet V2 KD)"},
    ]
    ...
    generate_noise_plot(all_results, save_path="noise_robustness.png")

    print("\n" + "=" * 60)
    print("  Noise robustness testing complete!")
    print("  Results saved to: noise_robustness.png")
    print("=" * 60)
