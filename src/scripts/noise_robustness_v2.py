...
================================================================================
 ...
 用法:
   ...
   python noise_robustness_v2.py --model weights/baseline_vgg_phase4_ste.pth --arch vgg
...
def generate_plot(all_results, save_path="docs/figures/noise_robustness_v2.png"):
    """生成噪声鲁棒性图表"""
    try:
        import matplotlib
        matplotlib.use('Agg')
        ...
        model_configs = [
            {
                ...
                "arch": "vgg",
                "path": "weights/baseline_vgg_phase4_ste.pth",
                "use_qat": True,
            },
            {
            ...
            },
            {
                ...
                "arch": "spacenet",
                "path": "weights/spacenet_v1_phase4_ste.pth",
                "use_qat": True,
            },
            {
                "name": "Model 3 (SpaceNet V2 KD int4)",
                "arch": "spacenet",
                "path": "weights/spacenet_v2_phase4_ste.pth",
                "use_qat": True,
            },
        ]
    elif model_path:
