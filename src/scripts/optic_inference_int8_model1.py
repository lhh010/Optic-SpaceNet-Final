...
================================================================================
 ...
 模型: Model 1 Baseline VGG Phase4 v3 (移植自 Model 2/3 v3 int8 配方)
   ...
   权重文件:  weights/baseline_vgg_phase4_v3_int8.pth       (变体 A)
              weights/baseline_vgg_phase4_v3_int8_vB.pth    (变体 B)
...
def main():
    ...
    weight_path = ("weights/baseline_vgg_phase4_v3_int8.pth" if variant == "A"
