...
================================================================================
 ...
 与原有文件的关系:
   - model2_spacenet_v1.py:       标准 float32 训练 (产出 weights/spacenet_v1.pth)
   - model2_spacenet_v1_qat.py:   QAT 微调 (产出 weights/spacenet_v1_qat.pth)
...
NUM_CLASSES = 10
SEED = 42
FP32_WEIGHTS = "weights/spacenet_v1.pth"        # 预训练 float32 权重
QAT_WEIGHTS = "weights/spacenet_v1_qat.pth"     # QAT 微调后输出权重
