...
================================================================================
 ...
 与原有文件的关系:
   - model1_baseline.py:       标准 float32 训练 (产出 baseline_vgg.pth)
   - model1_baseline_qat.py:   QAT 微调 (产出 baseline_vgg_qat.pth)
...
IMG_SIZE = 64
SEED = 42
FP32_WEIGHTS = "baseline_vgg.pth"       # 预训练 float32 权重
QAT_WEIGHTS = "baseline_vgg_qat.pth"    # QAT 微调后输出权重
