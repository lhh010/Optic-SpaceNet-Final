...
> 日期: 2026-07-10 (quick 50) → 2026-07-11 (全量 + 根因调查)
...
## 全量 5400 张 osimulator 推理 (2026-07-11)
...
| 指标 | 值 |
|---|---|
| 光计算准确率 | **~88%** (未跑完, 50% 时 88.41%) |
| QAT 参考 (test set) | **94.57%** (PyTorch 伪量化) |
| QAT 参考 (val set) | 91.06% (训练时验证) |
| 量化损失 vs QAT test | **~-6.6%** |
| 光计算占比 | 90.65% |
| 硬件对齐率 | 99.6% |

**进度 (50%):**
```
 540/5400 ( 10.0%) acc=85.93%
1080/5400 ( 20.0%) acc=87.13%
1620/5400 ( 30.0%) acc=87.59%
2160/5400 ( 40.0%) acc=87.87%
2700/5400 ( 50.0%) acc=88.41%
```
