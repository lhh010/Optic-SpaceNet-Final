...
================================================================================
 ...
 产出权重: spacenet_v2_phase4_v3_int8.pth (或 _int4.pth)
================================================================================
"""
...
class KDPhase4V3Trainer:
    ...
    def run(self):
        ...
        fname = cfg.get('save_path', f'spacenet_v2_phase4_v3_int{wbits}.pth')
...
def main():
    ...
    config = {
        ...
        'save_path': f'spacenet_v2_phase4_v3_int{wbits}.pth',
