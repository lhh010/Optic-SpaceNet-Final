...
================================================================================
 ...
 与原有文件的关系:
   - model3_spacenet_v2.py:       标准 KD 训练 (产出 weights/spacenet_v2_distilled.pth)
   - model3_spacenet_v2_qat.py:   QAT 微调 (产出 weights/spacenet_v2_qat.pth)
...
# 文件路径
FP32_WEIGHTS = "weights/spacenet_v2_distilled.pth"   # 预训练 KD float32 权重
QAT_WEIGHTS = "weights/spacenet_v2_qat.pth"          # QAT 微调后输出权重
TEACHER_WEIGHTS = "weights/teacher_resnet18.pth"     # 教师权重 (Mode B 需要)
