...
================================================================================
 ...
 模型: Model 2 SpaceNet V1 Phase4 v2 (INT4)
   ...
   权重文件:  weights/spacenet_v1_phase4_v2_ste.pth
...
def evaluate_optic(model_class, weight_path, engine, test_loader, device,
    ...
    if result['accuracy'] < 0.85:
        print(f"  [WARN] 精度 < 85%! 检查权重文件是否匹配 (应为 weights/spacenet_v1_phase4_v2_ste.pth)")
...
def main():
    ...
    weight_path = "weights/spacenet_v1_phase4_v2_ste.pth"
