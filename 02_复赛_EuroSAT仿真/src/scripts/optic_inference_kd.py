...
================================================================================
 ...
 模型: Model 3 SpaceNet V2 KD Phase4 v2 (KD + INT4)
   ...
   权重文件:  weights/spacenet_v2_phase4_v2_ste.pth
...
def main():
    ...
    if weight_path is None:
        if os.path.exists("weights/spacenet_v2_phase4_v3_int8.pth"):
            weight_path = "weights/spacenet_v2_phase4_v3_int8.pth"
        else:
            weight_path = "weights/spacenet_v2_phase4_v2_ste.pth"
