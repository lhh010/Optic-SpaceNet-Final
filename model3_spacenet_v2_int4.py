...
def build_teacher(num_classes=10):
    ...
    if os.path.exists("teacher_resnet18.pth"):
        state = torch.load("teacher_resnet18.pth", map_location='cpu')
        teacher.load_state_dict(state)
        print(f"  教师权重加载自: teacher_resnet18.pth")
    else:
...
def main():
    ...
    torch.save(model.state_dict(), "spacenet_v2_int4.pth")
