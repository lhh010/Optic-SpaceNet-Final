...
import os, json, time
import numpy as np
os.environ['J1_WEIGHTS_DIR']='/home/uisrc/j1/weights_j1'
os.environ['J1_FAKE']='1'
sys_path='/home/uisrc/j1'
...
json.dump(calib, open('/home/uisrc/j1/calib_j1_real.json','w'), indent=2)
print('saved calib_j1_real.json')
