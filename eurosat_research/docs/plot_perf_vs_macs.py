...
points = [
    ...
    # M5-M8 (决赛新模型, v8 漂移鲁棒 QAT, 2026-08-09, test 5400)
    ("M7 v8",                       0.86, 95.00, "M5-M8 (v8)", (8, -14)),
    ("M6 v8",                       1.38, 95.22, "M5-M8 (v8)", (8, 6)),
    ("M8 v8",                       2.16, 96.26, "M5-M8 (v8)", (8, -10)),
    ("M5 v8",                       5.31, 96.65, "M5-M8 (v8)", (-70, 6)),
]
...
groups = {
    ...
    "M5-M8 (v8)":        dict(color="#d62728", marker="X", s=110),
}
