...
[`复赛文档/`](复赛文档/) 目录包含本届复赛（CICC 1003564 · 曦智科技 Gazelle 命题）的全部提交材料：三份正式报告、答辩 PPT，以及两段讲解/演示视频。每份报告同时提供 **Markdown 源**（`.md`，便于阅读与维护）与**带封面定稿 PDF**（`-加封面.pdf`，为最终提交版本）。

### 正式文档

| 材料 | 提交版 PDF | 源文件 | 内容 |
|------|-----------|--------|------|
| **01 · 设计报告** | [`01_设计报告-加封面.pdf`](复赛文档/01_设计报告-加封面.pdf) | [`01_设计报告.md`](复赛文档/01_设计报告.md) | 项目背景、Gazelle 硬件平台、三模型架构设计、量化方法对比、训练到光计算硬件的映射 |
| **02 · 验证报告** | [`02_验证报告-加封面.pdf`](复赛文档/02_验证报告-加封面.pdf) | [`02_验证报告.md`](复赛文档/02_验证报告.md) | 精度 / 光计算占比 / 噪声鲁棒性 / 推理速率 / 硬件对齐率验证，基于 osimulator 真机仿真给出可信结论 |
| **03 · 技术数据** | [`03_技术数据-加封面.pdf`](复赛文档/03_技术数据-加封面.pdf) | [`03_技术数据.md`](复赛文档/03_技术数据.md) | 仓库结构、完整复现步骤、关键脚本说明、依赖清单与编码规范 |
| **答辩 PPT** | [`答辩ppt-CICC1003564.pdf`](复赛文档/答辩ppt-CICC1003564.pdf) · [`.pptx`](复赛文档/答辩ppt-CICC1003564.pptx) | [`演示PPT文字稿.md`](复赛文档/演示PPT文字稿.md) | 现场答辩幻灯片；另附 [`答辩文档.md`](复赛文档/答辩文档.md) 按评分七大项准备的 Q&A 手册 |

### 视频

-  [`ppt讲解视频.mp4`](复赛文档/ppt讲解视频.mp4) — 答辩 PPT 全程讲解（约 130 MB）
- [`前端演示视频.mp4`](复赛文档/前端演示视频.mp4) — Demo 光|电逐层对比演示系统录屏；
`ppt讲解视频`在线观看 → [https://www.bilibili.com/video/BV1MVKm6hEsV](https://www.bilibili.com/video/BV1MVKm6hEsV)（详见下方 [Demo 演示系统](#demo-演示系统)）
...
├── 复赛文档/                      # 复赛提交材料: 设计/验证/技术数据报告 + 答辩PPT + 讲解/演示视频 (见上方「复赛材料」)
├── .gitignore
└── README.md
```
