...
================================================================================
 ...
 模型:
   Model 1 (Baseline VGG STE):     baseline_vgg_phase4_ste.pth     训练 98.07%
   Model 2 (SpaceNet V1 STE):      spacenet_v1_phase4_ste.pth      训练 92.87%
   Model 3 (SpaceNet V2 KD STE):   spacenet_v2_phase4_ste.pth      训练 93.22%
   Model 1 (Baseline VGG LSQ+):    baseline_vgg_phase4_lsqplus.pth 训练 61.72%
...
def print_report(results_qat, results_optic):
    ...
    print(f"    Model 1 STE:  96.46% int4  (baseline_vgg_phase4_ste.pth)")
    print(f"    Model 2 STE:  74.35% int4  (spacenet_v1_phase4_ste.pth)")
    print(f"    Model 3 STE:  78.26% int4  (spacenet_v2_phase4_ste.pth)")
    print(f"    Model 1 LSQ+: 61.72% int4  (baseline_vgg_phase4_lsqplus.pth)")
    print("=" * 100)
...
def main():
    ...
    # 模型配置
    models_ste = [
        {"class": BaselineVGG_Flat, "weight": "baseline_vgg_phase4_ste.pth",
         "name": "Model 1 Phase4 STE (VGG+BN)", "arch": "flat+BN", "qat": "v3"},
        {"class": OpticSpaceNet_Phase4, "weight": "spacenet_v1_phase4_ste.pth",
         "name": "Model 2 Phase4 STE (SpaceNet V1)", "arch": "seq+BN", "qat": "v3"},
        {"class": OpticSpaceNet_Phase4, "weight": "spacenet_v2_phase4_ste.pth",
         "name": "Model 3 Phase4 STE (KD+SpaceNet)", "arch": "seq+BN", "qat": "v3"},
    ]
    models_lsq = [
        {"class": BaselineVGG_Seq, "weight": "baseline_vgg_phase4_lsqplus.pth",
